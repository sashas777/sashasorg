...
class Zend_Mail_Protocol_Smtp extends Zend_Mail_Protocol_Abstract
{
     ...
     */
    public function __construct($host = 'localhost', $port = null, array $config = array())
    {
        if (isset($config['ssl'])) {
     ...
     *
     * @param  string $host The client hostname or IP address (default: localhost)
     * @throws Zend_Mail_Protocol_Exception
     * @return void
     */
    public function helo($host = 'localhost')
    {
